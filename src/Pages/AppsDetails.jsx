...
const AppsDetails = () => {
    ...
    const { title, companyName, downloads, ratingAvg, reviews, size, description} = app || {}
            ...
            <div className="flex flex-col md:flex-row gap-5 bg-base-100 shadow-sm">
                ...
                <div className="flex w-full flex-col">
                    ...
                    <div className='mb-10 mt-7 '>
                        <Link to="/install" className='bg-[#00d390] py-3 px-6 rounded-md text-white'>Install Now ({size} MB)</Link>
                    </div>
                </div>
            </div>
